  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        loader: ({ params }) =>
          fetch(
            `https://dance-academy-server-aumansur.vercel.app/dashboard/payment/${params.id}`
          ),
      },
      {
      ...
      //   loader: ({ params }) =>
      //     fetch(
      //       `https://dance-academy-server-aumansur.vercel.app/dashboard/updateAddedClass/${params.id}`
      //     ),
      // },
    ],
  },
